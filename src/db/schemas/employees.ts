...
// Generated on: 2025-10-29T21:27:36.538Z
//
...
import z from 'zod';
import { PhoneNumberSchema, EmailSchema } from './fields';

export const ZodEmployeesRow = z.object({
	birth_date: z.preprocess((val) => typeof val === "string" ? new Date(val.includes("T") ? val : `${val}T00:00:00Z`) : val, z.date()),
...
export const ZodEmployeesInsert = z.object({
	...
	csc_id: z.uuid().nullable().optional(),
...
export const ZodEmployeesRowToDb = z.object({
	birth_date: z.preprocess((val) => val instanceof Date ? val.toISOString().split("T")[0] : val, z.string()),
	cell_phone: PhoneNumberSchema.nullable(),
