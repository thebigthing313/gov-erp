...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      timesheet_employee_times: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "timesheet_employee_times_timesheet_employee_id_fkey"
    ...
    Functions: {
      decrypt_ssn: { Args: { p_employee_id: string }; Returns: string }
      employee_user_id: { Args: { p_employee_id: string }; Returns: string }
